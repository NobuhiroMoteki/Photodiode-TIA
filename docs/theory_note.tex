...
\paragraph{Step 1: Define the feedback impedance.}
...
\paragraph{Step 2: Opamp constraint.}
...
\paragraph{Step 3: Kirchhoff's current law at the inverting node.}
...
\paragraph{Step 4: Substitute the opamp constraint.}
...
\paragraph{Step 6: Expand the product.}
...
\paragraph{Step 7: Divide by $R_{\mathrm{f}}$ and add the shunt term.}
...
\paragraph{Step 8: Form the transfer function.}
...
\paragraph{Step 9: Identify the standard second-order form.}
...
\paragraph{Step 1: Butterworth condition.}
...
\paragraph{Step 2: Translate the condition to circuit parameters.}
...
\paragraph{Step 3: Solve for $C_{\mathrm{f}}$.}
...
\paragraph{Relation to the common approximation.}
